...
os.system("pdoc ./pytexutils -o ./docs --docformat numpy") #--logo https://casperfibaek.github.io/buteo/logo.png --favicon https://casperfibaek.github.io/buteo/favicon.ico -t ./docs_assets/")
