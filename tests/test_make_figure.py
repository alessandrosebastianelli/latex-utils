...
if __name__ == '__main__':
    ...
    latex_image = make_image('fig1.png', caption='My image', label='img1', preable=True)
    print(latex_image)
    ...
    latex_images = make_tabular_image(images, caption='My image', label='img1', preable=True)
    print(latex_images)
